...
control_codes:
    ...
    .byte $36 ; 36 ピ
    .byte $37 ; 37 プ
    .byte $38 ; 38 ペ katakana
    .byte $39 ; 39 ポ
    .byte $3a ; 3A バ
    .byte $3b ; 3B ビ
    .byte $3c ; 3C ブ
    .byte $3d ; 3D ベ katakana
    .byte $3e ; 3E ボ
    .byte $3f ; 3F ヴ
...
:   clc
    ...
    ldx #wallet_money-starting_sram
...
Object_Configs:
    ...
    OBJECT_CONFIG OBJTICK_ShowText_See, 0, 4, 0, 0, 0, 0 ; 2E - Flagset See

; $E661 - TICK object type #41
OBJTICK_ShowText_See:
...
B31_16bf:
    lda #$00
    ldx #.LOBYTE(SPRITEDEF_UNK_MISPLACED)
    ldy #.HIBYTE(SPRITEDEF_UNK_MISPLACED)
    jmp B31_16f9
...
B31_16f0:
    lda #$03
    ldx #.LOBYTE(SPRITEDEF_UNK_MISPLACED2)
    ldy #.HIBYTE(SPRITEDEF_UNK_MISPLACED2)
    jmp B31_16f9
