...
MSG_CREDITS_1:
.byte " A few months after saving",newLine
.byte "  the world from Giegue's",newLine
.byte "   invasion, ",nintenName," and",newLine
.byte " his friends meet once more.",stopText
MSG_CREDITS_2:
.byte "'Tis the season for spooks!",newLine
.byte " The kids get ready to go",newLine
.byte "    Trick or Treating.",stopText
MSG_CREDITS_3:
.byte "However... something brews",newLine
.byte "just around the corner...",stopText
MSG_CREDITS_4:
.byte "Murmurs of a haunted house",newLine
.byte "attraction float around the",newLine
.byte "   mouths of kids alike.",stopText
MSG_CREDITS_5:
.byte newLine
.byte "Are you up to the challenge?"
.byte stopText
MSG_CREDITS_6:
